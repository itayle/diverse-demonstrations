...
from src.patches.checkpointer import Checkpointer

logger = logging.getLogger(__name__)


@Trainer.register("gradient_descent_fixed", constructor="from_partial_objects")
class GradientDescentTrainer(Trainer):
    ...
    def _try_train(self) -> Tuple[Dict[str, Any], int]:
        ...
        for epoch in range(self._num_epochs):
            ...
            self._should_validate_this_epoch = (epoch % self._validate_every) == 0 or epoch == self._num_epochs - 1
